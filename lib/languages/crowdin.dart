const crowdin = {
  'ar-AR': {
    ...
    'The original freezer development team': 'فريق تطوير الفريزر الأصلي',
    'Donate': 'تبرع',
  ...
  'bg-BG': {
    ...
    'Loved tracks': 'Обичани песни',
    'Favorites': 'Любими',
    'All offline tracks': 'Всички офлайн песни',
    'Create new playlist': 'Създайте нов плейлист',
    'Cannot create playlists in offline mode':
        'Не могат да се създават плейлисти в офлайн режим',
    'Error': 'Грешка',
    'Error logging in! Please check your token and internet connection and try again.':
        'Грешка при влизане! Моля, проверете токена и интернет връзката си и опитайте отново.',
    'Dismiss': 'Отхвърляне',
    'Welcome to': 'Добре дошли в',
    'Please login using your Deezer account.':
        'Моля, влезте с вашия Deezer акаунт.',
    'Login using browser': 'Влезте с браузър',
    'Login using token': 'Влезте с токен',
    'Enter ARL': 'Въведете ARL',
    'Token (ARL)': 'Token (ARL)',
    'Save': 'Запазване',
    "If you don't have account, you can register on deezer.com for free.":
        'Ако нямате акаунт, можете да се регистрирате безплатно на deezer.com',
    'Open in browser': 'Отворете в браузъра',
    "By using this app, you don't agree with the Deezer ToS":
        'Използвайки това приложение, вие не се съгласявате с ToS на Deezer',
    'Play next': 'Играйте следващия',
    'Add to queue': 'Добавяне към опашката',
    'Add track to favorites': 'Добавете песен към любими',
    'Add to playlist': 'Добавяне към плейлиста',
    'Select playlist': 'Изберете списък за изпълнение',
    'Track added to': 'Песента е добавена към',
    'Remove from playlist': 'Премахнете от плейлиста',
    'Track removed from': 'Песента е премахната от',
    'Remove favorite': 'Премахнете от любими',
    'Track removed from library': 'Песента е премахната от библиотеката',
    'Go to': 'Отидете на',
    'Make offline': 'Направете офлайн',
    'Add to library': 'Добавете в библиотеката',
    'Remove album': 'Премахнете албума',
    'Album removed': 'Албумът е премахнат',
    'Remove from favorites': 'Премахнете от любими',
    'Artist removed from library': 'Изпълнителят е премахнат от библиотеката',
    'Add to favorites': 'Добавете в любими',
    'Remove from library': 'Премахнете от библиотеката',
    'Add playlist to library': 'Добавете плейлист в библиотеката',
    'Added playlist to library': 'Добавен плейлист в библиотеката',
    'Make playlist offline': 'Направете плейлист офлайн',
    'Download playlist': 'Свалете плейлист',
    'Create playlist': 'Създайте плейлист',
    'Title': 'Заглавие',
    'Description': 'Описание',
    'Private': 'Частен',
    'Collaborative': 'Кооперативен',
    'Create': 'Създайте',
    'Playlist created!': 'Плейлистът е създаден!',
    'Playing from:': 'Възпроизвеждане от:',
    'Queue': 'Опашка',
    'Offline search': 'Офлайн търсене',
    'Search Results': 'Резултати от търсене',
    'No results!': 'Няма резултати!',
    'Show all tracks': 'Показване на всички песни',
    'Show all playlists': 'Покажи всички плейлисти',
    'Settings': 'Настройки',
    'General': 'Общи',
    ...
    'Dark': 'Тъмен',
    'Black (AMOLED)': 'Черен (AMOLED)',
    'Deezer (Dark)': 'Deezer (тъмен)',
    'Primary color': 'Основен цвят',
    'Selected color': 'Избран цвят',
    'Use album art primary color':
        'Използвайте основния цвят на корицата на албума',
    'Warning: might be buggy': 'Предупреждение: може да има бъгове',
    'Mobile streaming': 'Мобилно стрийминг',
    'Wifi streaming': 'Wifi стрийминг',
    'External downloads': 'Външни изтегляния',
    'Content language': 'Език на съдържанието',
    'Not app language, used in headers. Now':
        'Не език на приложението, използва се в заглавията. Сега',
    'Select language': 'Изберете език',
    'Content country': 'Страна на съдържанието',
    'Country used in headers. Now': 'Страна, използвана в заглавията. Сега',
    'Log tracks': 'Записване на песни',
    'Send track listen logs to Deezer, enable it for features like Flow to work properly':
        'Изпратете логовете за слушане на песни до Deezer, активирайте го за функции като Flow да работят правилно',
    'Offline mode': 'Офлайн режим',
    'Will be overwritten on start.': 'Ще бъде заменен при стартиране.',
    'Error logging in, check your internet connections.':
        'Грешка при влизане, проверете интернет връзките си.',
    'Logging in...': 'Влизане...',
    'Download path': 'Път за изтегляне',
    'Downloads naming': 'Име на изтеглянията',
    'Downloaded tracks filename': 'Файлово име на изтеглените песни',
    'Valid variables are': 'Валидни променливи са',
    'Reset': 'Нулирайте',
    'Clear': 'Изчистете',
    'Create folders for artist': 'Създайте папки за изпълнител',
    'Create folders for albums': 'Създайте папки за албуми',
    'Separate albums by discs': 'Разделяйте албумите по дискове',
    'Overwrite already downloaded files':
        'Презаписвайте вече изтеглени файлове',
    'Copy ARL': 'Копирайте ARL',
    'Copy userToken/ARL Cookie for use in other apps.':
        'Копирайте userToken/ARL Cookie за използване в други приложения.',
    'Copied': 'Копирано',
    'Log out': 'Излезте',
    'Due to plugin incompatibility, login using browser is unavailable without restart.':
        'Поради несъвместимост на приставките, влизането с браузър е недостъпно без рестарт.',
    '(ARL ONLY) Continue': '(ARL ONLY) Продължи',
    'Log out & Exit': 'Излез и напусни',
    'Pick-a-Path': 'Избор на път',
    'Select storage': 'Избери хранилище',
    'Go up': 'Отиди нагоре',
    ...
    'Radio': 'Радио',
    'Flow': 'Поток',
    'Track is not available on Deezer!': 'Пистовете не са налични в Deezer!',
    'Failed to download track! Please restart.':
        'Неуспешно изтегляне на пист! Моля, рестартирайте.',
    'Storage permission denied!': 'Достъпът до хранилището е отказан!',
    'Failed': 'Неуспешно',
    'Queued': 'В опашката',
    'External': 'Хранилище',
    'Restart failed downloads': 'Рестартиране на неуспешни изтегляния',
    'Clear failed': 'Изчисти неуспешните',
    'Download Settings': 'Настройки за изтегляне',
    'Create folder for playlist': 'Създай папка за плейлист',
    'Download .LRC lyrics': 'Изтегли .LRC текстовете',
    'Proxy': 'Прокси',
    'Not set': 'Не е зададено',
    'Search or paste URL': 'Търсене или поставяне на URL',
    'History': 'История',
    'Download threads': 'Паралелни изтегляния',
    'Lyrics unavailable, empty or failed to load!':
        'Текстовете не са налични, празни или не могат да се заредят!',
    'About': 'За нас',
    'Telegram Channel': 'Telegram канал',
    'To get latest releases': 'За последните релизи',
    'Official chat': 'Официален чат',
    'Telegram Group': 'Telegram група',
    'Huge thanks to all the contributors! <3':
        'Огромни благодарности на всички участници! <3',
    'Edit playlist': 'Редактиране на плейлист',
    'Update': 'Актуализиране',
    'Playlist updated!': 'Плейлистът е обновен!',
    'Downloads added!': 'Добавени изтегляния!',
    'Save cover file for every track': 'Запази обложка за всеки пист',
    'Download Log': 'Журнал на изтеглянията',
    'Repository': 'Репозиториум',
    'Source code, report issues there.':
        'Изходен код, докладвайте проблеми там.',
    'Use system theme': 'Използвай системна тема',
    'Light': 'Светла',
    'Popularity': 'Популярност',
    'User': 'Потребител',
    'Track count': 'Брой песни',
    "If you want to use custom directory naming - use '/' as directory separator.":
        "Ако искате да използвате персонализирано именуване на директории - използвайте '/' като разделител на директорията.",
    'Share': 'Сподели',
    'Save album cover': 'Запази обложка на албума',
    'Warning': 'Предупреждение',
    'Using too many concurrent downloads on older/weaker devices might cause crashes!':
        'Използването на твърде много паралелни изтегляния на по-стари/слаби устройства може да доведе до сривове!',
    'Create .nomedia files': 'Създай .nomedia файлове',
    'To prevent gallery being filled with album art':
        'За да предотвратиш запълване на галерията с корици на албуми',
    'Sleep timer': 'Таймер за сън',
    'Minutes:': 'Минути:',
    'Hours:': 'Часове:',
    'Cancel current timer': 'Отмяна на текущия таймер',
    'Current timer ends at': 'Текущият таймер свършва в',
    'Smart track list': 'Умен списък с песни',
    'Shuffle': 'Разбъркване',
    'Library shuffle': 'Разбъркване на библиотеката',
    'Ignore interruptions': 'Игнорирай прекъсванията',
    'Requires app restart to apply!':
        'Необходимо е рестартиране на приложението, за да се приложи!',
    'Ask before downloading': 'Попитай преди да изтеглиш',
    'Search history': 'История на търсене',
    'Clear search history': 'Изчисти история на търсене',
    'LastFM': 'LastFM',
    'Login to enable scrobbling.': 'Влез, за да активираш скроблирането.',
    'Login to LastFM': 'Вход в LastFM',
    'Username': 'Потребителско име',
    'Password': 'Парола',
    'Login': 'Влез',
    'Authorization error!': 'Грешка при авторизация!',
    'Logged out!': 'Излязохте!',
    'Lyrics': 'Текстове',
    'Player gradient background': 'Фон с градиент за плейъра',
    'Updates': 'Актуализации',
    'You are running latest version!':
        'Приложението е актуализирано до последната версия!',
    ...
    'Play mix': 'Изпълни микс',
    'Share show': 'Сподели шоу',
    'Date added': 'Дата на добавяне',
    'Discord': 'Discord',
    'Official Discord server': 'Официален Discord сървър',
    'Restart of app is required to properly log out!':
        'Необходимо е рестартиране на приложението, за да се излезе правилно!c',
    'Artist separator': 'Разделител на артисти',
    'Singleton naming': 'Singleton naming',
    'Keep the screen on': 'Дръж екрана включен',
    'Wakelock enabled!': 'Wakelock активиран!',
    'Wakelock disabled!': 'Wakelock деактивиран!',
    'Show all shows': 'Покажи всички предавания',
    'Episodes': 'Епизоди',
    'Show all episodes': 'Покажи всички епизоди',
    'Album cover resolution': 'Разделителна способност на корицата на албума',
    "WARNING: Resolutions above 1200 aren't officially supported":
        'ПРЕДУПРЕЖДЕНИЕ: Разделения над 1200 не са официално поддържани',
    ...
    'The original freezer development team':
        'Оригиналният екип за разработка на фризери',
    'Donate': 'дарявам',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!':
        'Разрешението е отказано, изтеглянето е отменено!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'cs-CZ': {
    ...
    'Not app language, used in headers. Now':
        'Není jazyk aplikace, používá se v záhlaví. Teď',
    'Select language': 'Vyberte jazyk',
    'Content country': 'Země obsahu',
    ...
    'Downloads naming': 'Pojmenování ke stažení',
    'Downloaded tracks filename': 'Název souboru stažených skladeb',
    'Valid variables are': 'Platné proměnné jsou',
    'Reset': 'Resetovat',
    'Clear': 'Jasný',
    'Create folders for artist': 'Vytvořte složky pro umělce',
    'Create folders for albums': 'Vytvářejte složky pro alba',
    'Separate albums by discs': 'Oddělte alba podle disků',
    'Overwrite already downloaded files': 'Přepsat již stažené soubory',
    'Copy ARL': 'Zkopírujte ARL',
    'Copy userToken/ARL Cookie for use in other apps.':
        'Zkopírujte soubor cookie userToken/ARL pro použití v jiných aplikacích.',
    'Copied': 'Zkopírováno',
    'Log out': 'Odhlaste se',
    'Due to plugin incompatibility, login using browser is unavailable without restart.':
        'Z důvodu nekompatibility pluginu je přihlášení pomocí prohlížeče bez restartu nedostupné.',
    '(ARL ONLY) Continue': '(POUZE ARL) Pokračujte',
    'Log out & Exit': 'Odhlásit a ukončit',
    'Pick-a-Path': 'Vyberte si cestu',
    ...
    'Radio': 'Rádio',
    'Flow': 'Flow',
    'Track is not available on Deezer!': 'Skladba není na Deezeru dostupná',
    'Failed to download track! Please restart.':
        'Stažení skladby se nezdařilo! Restartujte prosím.',
    'Storage permission denied!': 'Povolení k ukládání odepřeno!',
    'Failed': 'Nepodařilo',
    'Queued': 'Ve frontě',
    'External': 'Uložiště',
    'Restart failed downloads': 'Restartujte neúspěšné stahování',
    'Clear failed': 'Vymazání se nezdařilo',
    'Download Settings': 'Nastavení stahování',
    'Create folder for playlist': 'Vytvořte složku pro seznam skladeb',
    'Download .LRC lyrics': 'Stáhněte si texty .LRC',
    'Proxy': 'Proxy',
    'Not set': 'Nenastaveno',
    'Search or paste URL': 'Vyhledejte nebo vložte adresu URL',
    'History': 'Dějiny',
    'Download threads': 'Souběžné stahování',
    'Lyrics unavailable, empty or failed to load!':
        'Texty jsou nedostupné, prázdné nebo se nepodařilo načíst!',
    'About': 'O mně',
    'Telegram Channel': 'Telegramový kanál',
    'To get latest releases': 'Chcete-li získat nejnovější verze',
    'Official chat': 'Oficiální chat',
    'Telegram Group': 'Skupina telegramů',
    'Huge thanks to all the contributors! <3':
        'Velký dík všem přispěvatelům! <3',
    'Edit playlist': 'Upravit playlist',
    'Update': 'Aktualizovat',
    'Playlist updated!': 'Playlist aktualizován!',
    'Downloads added!': 'Stahování přidáno!',
    'Save cover file for every track':
        'Uložte soubor s obálkou pro každou skladbu',
    ...
    'Warning': 'Varování',
    'Using too many concurrent downloads on older/weaker devices might cause crashes!':
        'Použití příliš velkého počtu souběžných stahování na starších/slabších zařízeních může způsobit selhání!',
    'Create .nomedia files': 'Vytvářejte soubory .nomedia',
    'To prevent gallery being filled with album art':
        'Aby se zabránilo zaplnění galerie obrázky alb',
    'Sleep timer': 'Časovač spánku',
    'Minutes:': 'Zápis:',
    'Hours:': 'Hodiny:',
    'Cancel current timer': 'Zrušit aktuální časovač',
    'Current timer ends at': 'Aktuální časovač končí v',
    'Smart track list': 'Inteligentní seznam skladeb',
    'Shuffle': 'Zamíchat',
    'Library shuffle': 'Náhodně v knihovně',
    'Ignore interruptions': 'Ignorujte přerušení',
    'Requires app restart to apply!': 'Aplikace vyžaduje restart aplikace!',
    'Ask before downloading': 'Před stažením se zeptejte',
    'Search history': 'Historie vyhledávání',
    'Clear search history': 'Vymazat historii vyhledávání',
    'LastFM': 'LastFM',
    'Login to enable scrobbling.':
        'Chcete-li povolit scrobbling, přihlaste se.',
    'Login to LastFM': 'Přihlaste se do LastFM',
    ...
    'Logged out!': 'Odhlášen!',
    'Lyrics': 'Text',
    'Player gradient background': 'Přechodové pozadí hráče',
    'Updates': 'Aktualizace',
    'You are running latest version!': 'Používáte nejnovější verzi!',
    ...
    'Play mix': 'Hrát mix',
    'Share show': 'Sdílejte show',
    'Date added': 'Datum přidání',
    'Discord': 'Discord',
    'Official Discord server': 'Oficiální Discord server',
    'Restart of app is required to properly log out!':
        'Pro správné odhlášení je nutný restart aplikace!',
    'Artist separator': 'Oddělovač umělců',
    'Singleton naming': 'Singleton naming',
    'Keep the screen on': 'Nechte obrazovku zapnutou',
    'Wakelock enabled!': 'Zámek probuzení povolen!',
    'Wakelock disabled!': 'Zámek buzení deaktivován!',
    'Show all shows': 'Zobrazit všechny pořady',
    'Episodes': 'Epizody',
    'Show all episodes': 'Zobrazit všechny epizody',
    'Album cover resolution': 'Rozlišení obalu alba',
    "WARNING: Resolutions above 1200 aren't officially supported":
        'VAROVÁNÍ: Rozlišení nad 1200 nejsou oficiálně podporována',
    'Album removed from library!': 'Album bylo odstraněno z knihovny!',
    'Remove offline': 'Odebrat offline',
    'Playlist removed from library!': 'Playlist odstraněn z knihovny!',
    'Blur player background': 'Rozostření pozadí přehrávače',
    'Might have impact on performance': 'Může mít vliv na výkon',
    'Font': 'Písmo',
    'Select font': 'Vyberte písmo',
    "This app isn't made for supporting many fonts, it can break layouts and overflow. Use at your own risk!":
        "This app isn't made for supporting many fonts, it can break layouts and overflow. Use at your own risk!",
    ...
    'ISRC': 'ISRC',
    'UPC': 'UPC',
    'Track total': 'Celkový počet stop',
    'BPM': 'BPM',
    ...
    'Email': 'Email',
    'Missing email or password!': 'Chybí e-mail nebo heslo!',
    'Error logging in using email, please check your credentials.\nError:':
        'Chyba při přihlašování pomocí e-mailu, zkontrolujte prosím své přihlašovací údaje.\nChyba:',
    'Error logging in!': 'Chyba při přihlašování!',
    'Change display mode': 'Změňte režim zobrazení',
    'Enable high refresh rates': 'Povolit vysoké obnovovací frekvence',
    'Display mode': 'Režim zobrazení',
    'Spotify v1': 'Spotify v1',
    'Import Spotify playlists up to 100 tracks without any login.':
        'Importujte seznamy skladeb Spotify až na 100 skladeb bez přihlášení.',
    'Download imported tracks': 'Stáhněte si importované skladby',
    'Start import': 'Spusťte import',
    'Spotify v2': 'Spotify v2',
    'Import any Spotify playlist, import from own Spotify library. Requires free account.':
        'Importujte jakýkoli seznam skladeb Spotify, importujte z vlastní knihovny Spotify. Vyžaduje bezplatný účet.',
    'Spotify Importer v2': 'Spotify Importer v2',
    'This importer requires Spotify Client ID and Client Secret. To obtain them:':
        'Tento importér vyžaduje ID klienta Spotify a tajný klíč klienta. Chcete-li je získat:',
    '1. Go to: developer.spotify.com/dashboard and create an app.':
        '1. Přejděte na: developer.spotify.com/dashboard a vytvořte aplikaci.',
    'Open in Browser': 'Otevřít v prohlížeči',
    '2. In the app you just created go to settings, and set the Redirect URL to: ':
        '2. V aplikaci, kterou jste právě vytvořili, přejděte do nastavení a nastavte adresu URL přesměrování na:',
    'Copy the Redirect URL': 'Zkopírujte adresu URL přesměrování',
    'Client ID': 'ID klienta',
    'Client Secret': 'Tajemství klienta',
    'Authorize': 'Povolit',
    'Logged in as: ': 'Přihlášen jako:',
    'Import playlists by URL': 'Importujte seznamy skladeb podle adresy URL',
    'URL': 'URL',
    'Options': 'Možnosti',
    'Invalid/Unsupported URL': 'Neplatná/nepodporovaná adresa URL',
    'Please wait...': 'Čekejte prosím...',
    'Login using email': 'Přihlaste se pomocí emailu',
    'Track removed from offline!': 'Skladba odstraněna z režimu offline!',
    'Removed album from offline!': 'Album bylo odstraněno z režimu offline!',
    'Playlist removed from offline!': 'Playlist odstraněn z režimu offline!',
    'Repeat': 'Opakovat',
    'Repeat one': 'Opakujte jeden',
    'Repeat off': 'Opakujte',
    'Love': 'Láska',
    'Unlove': 'Nemilovat',
    'Dislike': 'Nechuť',
    'Close': 'Blízko',
    'Sort playlist': 'Seřadit seznam skladeb',
    'Sort ascending': 'Seřadit vzestupně',
    'Sort descending': 'Seřadit sestupně',
    'Stop': 'Zastávka',
    'Start': 'Start',
    'Clear all': 'Vymazat vše',
    'Play previous': 'Přehrát předchozí',
    'Play': 'Hrát',
    'Pause': 'Pauza',
    'Remove': '\nOdstranit',
    'Seekbar': 'Panel hledání',
    'Singles': 'Svobodní',
    'Featured': 'Nejlepší',
    'Fans': 'Fanoušci',
    'Duration': 'Trvání',
    'Sort': 'Seřadit',
    'Your ARL might be expired, try logging out and logging back in using new ARL or browser.':
        'Platnost vašeho ARL možná vypršela, zkuste se odhlásit a znovu přihlásit pomocí nového ARL nebo prohlížeče.',
    'The original freezer development team': 'Původní vývojový tým Freezer',
    'Donate': 'Darovat',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!':
        'Povolení odepřeno, stahování zrušeno!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'de-DE': {
    ...
    'Library': 'Bibliothek',
    "Offline mode, can't play flow or smart track lists.":
        'Offline-Modus, Flow oder intelligente Titellisten können nicht abgespielt werden.',
    'Added to library': 'Zur Bibliothek hinzugefügt',
    'Download': 'Herunterladen',
    'Disk': 'Disk',
    'Offline': 'Offline',
    'Top Tracks': 'Top-Titel',
    'Show more tracks': 'Mehr Titel anzeigen',
    'Top': 'Top',
    'Top Albums': 'Top-Alben',
    'Show all albums': 'Alle Alben anzeigen',
    'Discography': 'Diskografie',
    'Default': 'Standard',
    'Reverse': 'Rückwärts',
    ...
    'Delete': 'Löschen',
    'Are you sure you want to delete this download?':
        'Sind Sie sicher, dass Sie diesen Download löschen möchten?',
    'Cancel': 'Abbrechen',
    'Downloads': 'Downloads',
    'Clear queue': 'Warteschlange leeren',
    "This won't delete currently downloading item":
        'Dies löscht nicht den aktuell herunterladenden Artikel',
    'Are you sure you want to delete all queued downloads?':
        'Sind Sie sicher, dass Sie alle ausstehenden Downloads löschen möchten?',
    'Clear downloads history': 'Download-Verlauf löschen',
    'WARNING: This will only clear non-offline (external downloads)':
        'WARNUNG: Dies löscht nur nicht-offline (externe Downloads) Dateien.',
    'Please check your connection and try again later...':
        'Bitte überprüfen Sie Ihre Verbindung und versuchen Sie es später noch einmal...',
    'Show more': 'Mehr anzeigen',
    'Importer': 'Importierer',
    'Currently supporting only Spotify, with 100 tracks limit':
        'Derzeit wird nur Spotify unterstützt, mit einer Begrenzung auf 100 Titel',
    'Due to API limitations': 'Aufgrund von API-Beschränkungen',
    'Enter your playlist link below': 'Geben Sie Ihre Playlist-URL unten ein',
    ...
    'Error': 'Fehler',
    'Error logging in! Please check your token and internet connection and try again.':
        'Fehler bei der Anmeldung! Bitte überprüfen Sie Ihren Token und Ihre Internetverbindung und versuchen Sie es erneut.',
    'Dismiss': 'Verwerfen',
    'Welcome to': 'Willkommen bei',
    'Please login using your Deezer account.':
        'Bitte melden Sie sich mit Ihrem Deezer-Konto an.',
    'Login using browser': 'Im Browser anmelden',
    'Login using token': 'Mit Token anmelden',
    'Enter ARL': 'ARL eingeben',
    'Token (ARL)': 'Token (ARL)',
    'Save': 'Speichern',
    "If you don't have account, you can register on deezer.com for free.":
        'Wenn Sie kein Konto haben, können Sie sich kostenlos auf deezer.com registrieren.',
    'Open in browser': 'Im Browser öffnen',
    "By using this app, you don't agree with the Deezer ToS":
        'Durch die Nutzung dieser App stimmen Sie den Nutzungsbedingungen von Deezer nicht zu.',
    ...
    'Track removed from library': 'Titel aus der Bibliothek entfernt',
    'Go to': 'Gehe zu',
    ...
    'Artist removed from library': 'Künstler aus der Bibliothek entfernt',
    'Add to favorites': 'Zu Favoriten hinzufügen',
    'Remove from library': 'Aus der Bibliothek entfernen',
    'Add playlist to library': 'Playlist zur Bibliothek hinzufügen',
    'Added playlist to library': 'Playlist zur Bibliothek hinzugefügt',
    ...
    'Use album art primary color': 'Primärfarbe des Albumcovers verwenden',
    ...
    'Log tracks': 'Titel protokollieren',
    'Send track listen logs to Deezer, enable it for features like Flow to work properly':
        'Titelprotokolle an Deezer senden, aktivieren Sie dies, damit Funktionen wie Flow ordnungsgemäß funktionieren.',
    'Offline mode': 'Offline-Modus',
    'Will be overwritten on start.': 'Wird beim Start überschrieben.',
    'Error logging in, check your internet connections.':
        'Fehler bei der Anmeldung, bitte überprüfen Sie Ihre Internetverbindung.',
    'Logging in...': 'Anmelden...',
    ...
    'Copy userToken/ARL Cookie for use in other apps.':
        'Kopieren Sie den Benutzer-Token/ARL-Cookie zur Verwendung in anderen Apps.',
    'Copied': 'Kopiert',
    'Log out': 'Abmelden',
    'Due to plugin incompatibility, login using browser is unavailable without restart.':
        'Aufgrund einer Plugin-Inkompatibilität ist die Anmeldung über den Browser ohne Neustart nicht verfügbar.',
    '(ARL ONLY) Continue': '(NUR ARL) Fortfahren',
    'Log out & Exit': 'Abmelden & Beenden',
    'Pick-a-Path': 'Pfad auswählen',
    ...
    'Failed to download track! Please restart.':
        'Fehler beim Herunterladen des Titels! Bitte starten Sie den Download erneut.',
    'Storage permission denied!': 'Speicherberechtigung verweigert!',
    ...
    'Download .LRC lyrics': '.LRC-Songtexte herunterladen',
    'Proxy': 'Proxy',
    ...
    'Lyrics unavailable, empty or failed to load!':
        'Songtexte nicht verfügbar, leer oder konnten nicht geladen werden!',
    'About': 'Über',
    ...
    'Huge thanks to all the contributors! <3':
        'Herzlichen Dank an alle Mitwirkenden! <3',
    ...
    'Use system theme': 'Systemvorgabe verwenden',
    'Light': 'Heller Modus',
    ...
    'Smart track list': 'Intelligente Titelliste',
    'Shuffle': 'Zufallswiedergabe',
    'Library shuffle': 'Zufallswiedergabe der Bibliothek',
    'Ignore interruptions': 'Unterbrechungen ignorieren',
    'Requires app restart to apply!':
        'Erfordert einen Neustart der App, um wirksam zu werden!',
    'Ask before downloading': 'Vor dem Herunterladen fragen',
    ...
    'Updates': 'Updates',
    'You are running latest version!': 'Sie verwenden die neueste Version!',
    ...
    'Restart of app is required to properly log out!':
        'Ein Neustart der App ist erforderlich, um sich richtig abzumelden!',
    'Artist separator': 'Künstler-Trennzeichen',
    'Singleton naming': 'Dateiname für Einzeltitel',
    ...
    "WARNING: Resolutions above 1200 aren't officially supported":
        'WARNUNG: Auflösungen über 1200 werden nicht offiziell unterstützt',
    'Album removed from library!': 'Album aus der Bibliothek entfernt!',
    'Remove offline': 'Offline entfernen',
    'Playlist removed from library!': 'Playlist aus der Bibliothek entfernt!',
    'Blur player background': 'Unscharfer Player-Hintergrund',
    'Might have impact on performance': 'Könnte die Leistung beeinträchtigen',
    'Font': 'Schriftart',
    ...
    'ISRC': 'ISRC',
    'UPC': 'UPC',
    'Track total': 'Titel insgesamt',
    'BPM': 'BPM',
    'Unsynchronized lyrics': 'Unsynchronisierter Songtext',
    'Genre': 'Genre',
    ...
    'Spotify v1': 'Spotify v1',
    'Import Spotify playlists up to 100 tracks without any login.':
        'Importieren Sie Spotify-Playlists mit bis zu 100 Titeln ganz ohne Anmeldung.',
    'Download imported tracks': 'Importierte Titel herunterladen',
    'Start import': 'Import beginnen',
    'Spotify v2': 'Spotify v2',
    'Import any Spotify playlist, import from own Spotify library. Requires free account.':
        'Importieren Sie jede Spotify-Playlist, importieren Sie aus Ihrer eigenen Spotify-Bibliothek. Erfordert ein kostenloses Konto.',
    'Spotify Importer v2': 'Spotify Importer v2',
    'This importer requires Spotify Client ID and Client Secret. To obtain them:':
        'Dieser Importer benötigt die Spotify Client-ID und das Client-Secret. Um diese zu erhalten:',
    '1. Go to: developer.spotify.com/dashboard and create an app.':
        '1. Gehen Sie zu: developer.spotify.com/dashboard und erstellen Sie eine App.',
    'Open in Browser': 'Im Browser öffnen',
    '2. In the app you just created go to settings, and set the Redirect URL to: ':
        '2. Gehen Sie in der gerade erstellten App zu den Einstellungen und setzen Sie die Weiterleitungs-URL auf: ',
    'Copy the Redirect URL': 'Weiterleitungs-URL kopieren',
    'Client ID': 'Client-ID',
    'Client Secret': 'Client-Secret',
    'Authorize': 'Autorisieren',
    'Logged in as: ': 'Angemeldet als: ',
    'Import playlists by URL': 'Playlists per URL importieren',
    'URL': 'URL',
    'Options': 'Optionen',
    'Invalid/Unsupported URL': 'Ungültig/Nicht unterstützte URL',
    'Please wait...': 'Bitte warten...',
    'Login using email': 'Mit E-Mail anmelden',
    'Track removed from offline!': 'Titel wurde aus Offline entfernt!',
    ...
    'Close': 'Schließen',
    'Sort playlist': 'Playlists sortieren',
    ...
    'Sort': 'Sortieren',
    'Your ARL might be expired, try logging out and logging back in using new ARL or browser.':
        'Ihre ARL ist möglicherweise abgelaufen. Versuchen Sie, sich ab- und wieder anzumelden, indem Sie eine neue ARL oder den Browser verwenden.',
    'The original freezer development team':
        'Das ursprüngliche Freezer-Entwicklungsteam',
    'Donate': 'Spenden',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!':
        'Zugriff verweigert, Download abgebrochen!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'el-GR': {
    ...
    'The original freezer development team':
        'Η αρχική ομάδα ανάπτυξης του Freezer',
    'Donate': 'Προσφέρω',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Download failed!': ' λήψη απέτυχε!',
    'Permission denied, download canceled!':
        'Η άδεια απορρίφθηκε, η λήψη ακυρώθηκε!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'hr-HR': {
    ...
    'The original freezer development team': 'Originalni tim za razvoj Freezer',
    'Donate': 'Donirajte',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!':
        'Dopuštenje odbijeno, preuzimanje otkazano!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'it-IT': {
    ...
    'The original freezer development team':
        'Il team di sviluppo originario di Freezer',
    'Donate': 'Donazioni',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!':
        'Permesso negato, download cancellato!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'nl-NL': {
    ...
    '1. Go to: developer.spotify.com/dashboard and create an app.':
        '1. Ga naar: developer.spotify.com/dashboard en maak een app.',
    'Open in Browser': 'In browser openen',
    '2. In the app you just created go to settings, and set the Redirect URL to: ':
        "2. In de app die je zojuist hebt gemaakt, ga naar de instellingen en vul de 'Redirect URL' in met: ",
    'Copy the Redirect URL': 'Kopieer de Redirect URL',
    'Authorize': 'Autoriseer',
    'Logged in as: ': 'Ingelogd als: ',
    'Import playlists by URL': 'Importeer afspeellijsten via URL',
    'Options': 'Opties',
    'Invalid/Unsupported URL': 'Ongeldige/niet-ondersteunde URL',
    'Please wait...': 'Een ogenblik geduld...',
    'Login using email': 'Inloggen via e-mail',
    'Track removed from offline!': 'Nummer is verwijderd van offline!',
  ...
  'pt-BR': {
    ...
    'The original freezer development team':
        'A equipe de desenvolvimento original do Freezer',
    ...
    'Permission denied, download canceled!':
        'Permissão negada, download cancelado!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'ro-RO': {
    ...
    'Repeat': 'Repeta',
    'Repeat one': 'Repetați unul',
    'Repeat off': 'Repetați',
    'Love': 'Dragoste',
    'Unlove': 'Neiubire',
    'Dislike': 'Nu-mi place',
    'Close': 'Aproape',
    'Sort playlist': 'Sortați lista de redare',
    'Sort ascending': 'Sortați crescător',
    'Sort descending': 'Sortați descendent',
    'Stop': 'Stop',
    'Start': 'Început',
    'Clear all': 'Ștergeți totul',
    'Play previous': 'Redați anterioară',
    'Play': 'Juca',
    'Pause': 'Pauză',
    'Remove': 'Elimina',
    'Seekbar': 'Bara de căutare',
    'Singles': 'Singles',
    'Featured': 'Prezentare',
    'Fans': 'Fani',
    'Duration': 'Durată',
    'Sort': 'Sorta',
    'Your ARL might be expired, try logging out and logging back in using new ARL or browser.':
        'ARL-ul dvs. ar putea fi expirat, încercați să vă deconectați și să vă conectați din nou utilizând noul ARL sau browser.',
    'The original freezer development team':
        'Echipa originală de dezvoltare a Freezer',
    'Donate': 'Dona',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!':
        '\nPermisiune refuzată, descărcare anulată!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'ru-RU': {
    ...
    'Album removed from library!': 'Альбом удалён из библиотеки!',
    'Remove offline': 'Отключить автономный режим',
    'Playlist removed from library!': 'Плейлист удалён из библиотеки!',
    ...
    'Email': 'Email',
    'Missing email or password!': 'Отсутствует e-mail или пароль!',
    'Error logging in using email, please check your credentials.\nError:':
        'Ошибка входа по e-mail, проверьте учетные данные.\nОшибка:',
    'Error logging in!': 'Ошибка авторизации!',
    'Change display mode': 'Изменить режим отображения',
    'Enable high refresh rates': 'Включить высокую частоту обновления',
    'Display mode': 'Режим отображения',
    'Spotify v1': 'Spotify v1',
    'Import Spotify playlists up to 100 tracks without any login.':
        'Импортировать плейлисты Spotify до 100 треков без авторизации.',
    'Download imported tracks': 'Скачать импортированные треки',
    'Start import': 'Начать импорт',
    'Spotify v2': 'Spotify v2',
    'Import any Spotify playlist, import from own Spotify library. Requires free account.':
        'Импортируйте любой плейлист Spotify, импортируйте из своей библиотеки Spotify. Требуется бесплатная учетная запись.',
    'Spotify Importer v2': 'Импортер Spotify V2',
    'This importer requires Spotify Client ID and Client Secret. To obtain them:':
        'Для работы этого импортера необходимы Client ID и Client Secret от Spotify. Чтобы их получить:',
    '1. Go to: developer.spotify.com/dashboard and create an app.':
        '1. Перейдите к: developer.spotify.com/dashboard и создайте приложение.',
    'Open in Browser': 'Открыть в Браузере',
    '2. In the app you just created go to settings, and set the Redirect URL to: ':
        '2. В созданном приложении перейдите в настройки и установите URL перенаправления как: ',
    'Copy the Redirect URL': 'Копировать URL перенаправления',
    'Client ID': 'Клиент ID',
    'Client Secret': 'Client Secret',
    'Authorize': 'Авторизация',
    'Logged in as: ': 'Вошли как: ',
    'Import playlists by URL': 'Импортировать плейлисты по URL',
    'URL': 'URL',
    'Options': 'Настройки',
    'Invalid/Unsupported URL': 'Неверный/Неподдерживающийся URL',
    'Please wait...': 'Пожалуйста подождите...',
    'Login using email': 'Вход с помощью email',
    'Track removed from offline!': 'Трек убран из автономного режима!',
    'Removed album from offline!': 'Убран альбом из автономного режима!',
    'Playlist removed from offline!': 'Плейлист убран из автономного режима!',
    'Repeat': 'Повтор',
    'Repeat one': 'Повтор один раз',
    'Repeat off': 'Выкл. повтор',
    'Love': 'Люблю',
    'Unlove': 'Не люблю',
    'Dislike': 'Дизлайк',
    'Close': 'Закрыть',
    'Sort playlist': 'Отсортировать плейлист',
    'Sort ascending': 'Сортировать по возрастанию',
    'Sort descending': 'Сортировать по убыванию',
    'Stop': 'Стоп',
    'Start': 'Начать',
    'Clear all': 'Очистить всё',
    'Play previous': 'Воспроизвести предыдущее',
    'Play': 'Воспроизвести',
    'Pause': 'Приостановить',
    'Remove': 'Убрать',
    'Seekbar': 'Ползунок',
    ...
    'Sort': 'Сортировка',
    'Your ARL might be expired, try logging out and logging back in using new ARL or browser.':
        'Срок действия вашего ARL возможно истёк, попробуйте выйти и войти с помощью нового ARL или браузера.',
    'The original freezer development team':
        'Оригинальная команда разработчиков freezer',
    'Donate': 'Пожертвовать',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!':
        'Доступ запрещен, загрузка отменена!',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!':
  ...
  'uwu-UWU': {
    ...
    'Error logging in!':
        "H-hewwo! I-i'm having twouble logging in >.< Pwease hewp me! x3",
    'Change display mode': 'Change dispway mode',
    'Enable high refresh rates': 'Enabwe high wefwesh wates',
    'Display mode': 'Dispway mode',
    'Import Spotify playlists up to 100 tracks without any login.':
        'Impowt Spotify pwaywists up tuwu 100 twacks without any wogin.',
    'Download imported tracks': 'Downwoad impowted twacks',
    'Start import': 'Stawt impowt',
    'Import any Spotify playlist, import from own Spotify library. Requires free account.':
        'Impowt any Spotify pwaywist, impowt fwom own Spotify wibwawy. Wequiwes fwee account.',
    'This importer requires Spotify Client ID and Client Secret. To obtain them:':
        'Thiws impowtew wequiwes Spotify Cwient D awnd Cwient Secwet. Tuwu obtain thewm:',
    '1. Go to: developer.spotify.com/dashboard and create an app.':
        '1. Gow tuwu: devewopew.spotify.com/dashboawd awnd cweate an app.',
    'Open in Browser': 'Open in bwowsew',
    '2. In the app you just created go to settings, and set the Redirect URL to: ':
        '2. In the app uwu juwst cweated gow tuwu settings, awnd set the Wediwect UWW tuwu: ',
    'Copy the Redirect URL': 'Copy the Wediwect UWW',
    'Client ID': 'Cwient ID',
    ...
    'Track removed from offline!': 'Twack wemuvd fwom offline!',
    'Removed album from offline!': 'Wemuvd album fwom offline!',
    'Playlist removed from offline!': 'Pwaywist wemuvd fwom offline!',
    'Play previous': 'Pway pwevious',
    'Play': 'Pway',
    'Duration': 'Duwation',
    'Sort': 'Sowt',
    'Your ARL might be expired, try logging out and logging back in using new ARL or browser.':
  ...
  'zh-CN': {
    ...
    'Email Login': '信箱登入',
    'Email': '電子郵件',
    'Missing email or password!': '缺少電子郵件或密碼！',
    'Error logging in using email, please check your credentials.\nError:':
        '使用電子郵件登入時發生錯誤，請檢查您的憑證。\n錯誤：',
    'Error logging in!': '登入時出錯！',
    'Change display mode': '變更顯示模式',
    'Enable high refresh rates': '啟用高更新率',
    'Display mode': '顯示方式',
    'Spotify v1': 'Spotify v1',
    'Import Spotify playlists up to 100 tracks without any login.':
        '無需登入即可匯入最多 100 首曲目的 Spotify 播放清單。',
    'Download imported tracks': '下載導入的曲目',
    'Start import': '開始導入',
    'Spotify v2': 'Spotify v2',
    'Import any Spotify playlist, import from own Spotify library. Requires free account.':
        '匯入任何 Spotify 播放列表，從自己的 Spotify 庫匯入。需要免費帳戶。',
    'Spotify Importer v2': 'Spotify 導入器 v2',
    'This importer requires Spotify Client ID and Client Secret. To obtain them:':
        '此導入器需要 Spotify 用戶端 ID 和客戶端金鑰。要獲得它們：',
    '1. Go to: developer.spotify.com/dashboard and create an app.':
        '1. 造訪：developer.spotify.com/dashboard 並建立一個應用程式。',
    'Open in Browser': '在瀏覽器中開啟',
    '2. In the app you just created go to settings, and set the Redirect URL to: ':
        '2. 在您剛剛建立的應用程式中，前往設置，並將重定向 URL 設定為：',
    'Copy the Redirect URL': '複製重定向 URL',
    'Client ID': '客戶端ID',
    'Client Secret': '客戶秘密',
    'Authorize': '授權',
    'Logged in as: ': '登入身分：',
    'Import playlists by URL': '透過 URL 匯入播放列表',
    'URL': 'URL',
    'Options': '選項',
    'Invalid/Unsupported URL': '無效/不受支援的 URL',
    'Please wait...': '請稍等...',
    'Login using email': '使用電子郵件登入',
    'Track removed from offline!': '曲目已從離線狀態刪除！',
    'Removed album from offline!': '已從離線狀態下刪除相簿！',
    'Playlist removed from offline!': '播放清單已從離線狀態刪除！',
    'Repeat': '重複',
    'Repeat one': '重複一',
    'Repeat off': '重複關閉',
    'Love': '愛',
    ...
    'Sort': '種類',
    'Your ARL might be expired, try logging out and logging back in using new ARL or browser.':
        '您的 ARL 可能已過期，請嘗試登出並使用新​​的 ARL 或瀏覽器重新登入。',
    'The original freezer development team': '原冰櫃開發團隊',
    'Donate': '捐',
    'You should rather support your favorite artists, instead of this app!':
    ...
    'Permission denied, download canceled!': '權限被拒絕，下載取消！',
    'Crowdin': 'Crowdin',
    'Help translating this app on Crowdin!': '幫助在 Crowdin 上翻譯此應用程式',
    'Allow screen to turn off': '允許螢幕關閉'
  }
};
